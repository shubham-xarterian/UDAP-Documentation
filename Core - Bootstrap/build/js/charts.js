...
(function () {
  ...
  var chart = document.querySelector("#stock-earning");
...
(function () {
  ...
  var chart = document.querySelector("#stock-customer");
...
(function () {
  ...
  var chart = document.querySelector("#stock-payouts");
...
(function () {
  var options = {
    ...
    xaxis: {
      type: "category",
      categories: ["Sep 12", "Sep 19", "Sep 26", "Oct 02", "Oct 09", "Oct 16", "Oct 23"],
      axisBorder: {
        show: false
      },
      axisTicks: {
