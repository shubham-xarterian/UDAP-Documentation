...
$(".js-show-sidebar, .js-close-sidebar").on("click", () => $("aside.sidebar, .overlay").toggleClass("active"));

// Overlay

$(".overlay").on("click", () => $("aside.sidebar, .overlay").removeClass("active"));

// Help sidebar

$(".js-help-sidebar").on("click", () => $(".help-sidebar").toggleClass("active"));
...
(function () {
  ...
  search_show.on("click", () => search.addClass("visible"));

  input.on("keyup", () => search.addClass("active"));

  input.on("focus blur", () => search.toggleClass("focus"));
...
$("#modal-product").on("shown.bs.modal", () => {
  let slider = $(".product-modal-slider").slick({
    slidesToShow: 3,
    slidesToScroll: 1,
    arrows: false,
    dots: false,
...
$("#modal-product").on("hidden.bs.modal", () => $(".product-modal-slider").slick("unslick"));
...
$('[data-bs-target="#modal-tab-comments"]').on("shown.bs.tab hidden.bs.tab", () => {
  $("#modal-product .modal-dialog").toggleClass("comments-show");
});

$("#modal-tab-comments .modal-close").on("click", () => $('[data-bs-target="#modal-tab-product"]').trigger("click"));
...
(function () {
  ...
  actions.each((i, e) => {
    ...
    head.on("click", () => $(e).toggleClass("active"));
    wrapper.on("mouseleave", () => $(e).removeClass("active"));
  });
})();
...
(function () {
  ...
  close.on("click", () => tabs.removeClass("customer-details-show"));
...
(function () {
  ...
  message_close.on("click", () => message_container.removeClass("active"));
})();
...
$(".sign-up-entry .btn-entry").on("click", function () {
  $(".sign-up-entry").fadeOut(200, () => $(".sign-up-code").fadeIn(200));
});
